...
HD_PWD='/home/victor/SolarRAT/SolarRAT_Driver/SolarRAT_Driver/SolarRAT_Driver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SolarRAT_Driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SolarRAT_Driver.tcl -notrace
