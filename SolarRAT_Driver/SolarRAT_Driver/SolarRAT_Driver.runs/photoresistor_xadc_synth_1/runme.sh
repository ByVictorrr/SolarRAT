...
HD_PWD='/home/victor/SolarRAT_Driver/SolarRAT_Driver.runs/photoresistor_xadc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log photoresistor_xadc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source photoresistor_xadc.tcl
