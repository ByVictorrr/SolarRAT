...
(0068)                            || 
(0069)                     0x015  || sweep:
(0070)  CS-0x015  0x36302         || 	MOV R3, SWEEP_COUNT ;sweep_count = 12
(0071)  CS-0x016  0x36402         || 	MOV R4, SWEEP_COUNT  
(0072)                            || 
...
(0077)                            || 	;else
(0078)  CS-0x019  0x36402         ||         MOV R4, SWEEP_COUNT ;	
(0079)                            || 
...
(0179)                            || 
(0180)  CS-0x03D  0x3690C         || 	MOV R9, BUBBLE_OUTER_COUNT ; outer_count = 10
(0181)                            || 
(0182)                     0x03E  || bubble_outer_loop: 
(0183)                            || 
(0184)  CS-0x03E  0x36A0C         || 	MOV R10, BUBBLE_INNER_COUNT ; inner_count = 3
(0185)                            || 	
(0186)                     0x03F  || bubble_inner_loop:
(0187)                            || 	;get index of k and k+1 from 0->
(0188)                            || 
(0189)                            ||         ;ADDR_i = 4
(0190)  CS-0x03F  0x36B0C         || 	MOV R11, BUBBLE_INNER_COUNT
(0191)                            || 	;ADD R11, 1
(0192)                            || 	
(0193)                            || 	; ADDR_i+1 = 5
(0194)  CS-0x040  0x36C0C         || 	MOV R12, BUBBLE_INNER_COUNT 
...
(0257)                            || 
(0258)                     0x058  || ISR:
(0259)  CS-0x058  0x33222         || 	IN R18, SWITCH_PORT
...
SWEEP_COUNT    0x002   (0035)  ||  0070 0071 0078 
SWITCH_PORT    0x022   (0026)  ||  0259 
